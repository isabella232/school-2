...
ActiveRecord::Schema.define(version: 20160822062501) do
  ...
  create_table "refinery_employees_roles", force: :cascade do |t|
    t.string   "title"
    t.integer  "position"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "refinery_sections", force: :cascade do |t|
    t.string   "title"
  ...
  create_table "refinery_students", force: :cascade do |t|
    t.string   "first_name"
    t.string   "middle_name"
    t.string   "last_name"
    t.integer  "photo_id"
